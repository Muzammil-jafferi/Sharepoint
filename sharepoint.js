...
// var SP_USER = "concordia@fractal.ai";
// var SP_PASS = "Unifi@2018";
var SP_USER = "muzammil.jafferi@feffem.com";
var SP_PASS = "Concordia@4321";
var SP_URL = "https://team.effem.com";
// var SP_URL = "https://fractalanalytic.sharepoint.com";
var SP_HOST = SP_URL.toLowerCase()
  .replace("https://", "")
  .replace("http://", "");
...
var gAuthCookie2 = "";
var gStrReqDig = "";
// var gStrFilePath = "/sites/concordia-dev/Shared Documents/"; // text test
var gStrFilePath = "/sites/GlobalTPM/Global Template/test"; // text test

var gStrFileLoca = "./"; // text test
var gStrFileName = "mysamplefile.csv"; // text test
/*
...
Promise.resolve()
      ...
      var request = https.request(options, res => {
        ...
        res.on("end", () => {
          ...
          if (
            ...
            gBinarySecurityToken = doc.documentElement
              .getElementsByTagName("wsse:BinarySecurityToken")
  ...
  .then(() => {
    ...
    return new Promise(function(resolve, reject) {
      ...
      var request = https.request(options, response => {
        ...
        gAuthCookie1 = response.headers["set-cookie"][0].substring(
          0,
          response.headers["set-cookie"][0].indexOf(";")
        );
        gAuthCookie2 = response.headers["set-cookie"][1].substring(
          0,
          response.headers["set-cookie"][1].indexOf(";")
        );
        resolve();
      });
      request.on("error", e => {
  ...
  .then(data => {
    ...
    // sprLib.baseUrl("/sites/concordia-dev/");
    sprLib.baseUrl("/sites/GlobalTPM/");
  ...
  .then(strDigest => {
    ...
    // return sprLib
    //   .list({ name: "Announcements", requestDigest: gStrReqDig })
    //   .create({ Title: "created with Node demo" });
  })
  .then(objCrud => {
    console.log("..\n..create done!");
